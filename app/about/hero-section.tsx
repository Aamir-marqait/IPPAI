        ...
        <main className="flex max-w-screen-xl md:max-w-[1100px] mx-auto flex-col items-start justify-center mt-6 sm:mt-10 px-4 sm:px-6 md:px-8">
          <div className="w-full">
            <div className="text-center mb-8 sm:mb-12">
              <h1 className="text-left text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[40px] 2xl:text-7xl font-bold font-red-hat-display text-[#D3363B] mb-4 sm:mb-6 leading-tight sm:leading-[150%]">
                About Us
              </h1>
