        ...
        >
          ...
          <div className="text-[#333931] text-[16px] font-inter font-normal leading-[24px] mb-5 mt-2">
            ...
            <div className="flex items-start mb-1">
              ...
              <span className="text-[#333931] text-[16px] font-inter font-normal leading-[24px]">
                {event.aboutEvent.details[0]?.text}
              </span>
            </div>
            <div className="flex items-start mb-1">
              <svg
              ...
              <span className="text-[#333931] text-[16px] font-inter font-normal leading-[24px]">
                {event.aboutEvent.details[1]?.text}
              </span>
            </div>
            <div className="flex items-start mb-1">
              <svg
              ...
              <span className="text-[#333931] text-[16px] font-inter font-normal leading-[24px]">
                {event.aboutEvent.details[2]?.text}
              </span>
            </div>
          </div>
          <div
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start">
              ...
              <span className="text-[#333931] text-[16px] font-inter font-normal leading-[24px]">
                Gift Cards worth INR 30,000 from Amazon, Flipkart, and
            ...
            <div className="flex items-start">
              ...
              <span className="text-[#333931] text-[16px] font-inter font-normal leading-[24px]">
                ...
                Bring a colleague along! The more, the merrier! Share this with
                your network and get them to register, too—it&apos;s always more
                fun to start this journey together.
              </span>
            </div>
          </div>
