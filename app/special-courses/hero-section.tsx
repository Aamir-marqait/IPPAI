...
//   return (
//     <section className=" relative min-h-[380px] sm:min-h-[420px] lg:min-h-[430px] xl:min-h-[470px] w-full flex items-center justify-center bg-[#1c1c1c] overflow-hidden px-5 md:px-5 lg:px-0 pt-28">
//       <Image
//         src="/schero.png"
//         alt="Background"
//         fill
...
//           <div className="text-white font-poppins font-normal xl:text-[18px] xl:leading-[27px] xl:tracking-[0.32px] mb-5 text-sm md:text-base">
...
export default async function SpecialCoursesHero() {
