      ...
      <div className="relative z-10 pt-20">
        <main className="flex max-w-[1100px]  min-h-80 mx-auto flex-col items-center justify-center   text-center">
          <div className="w-full">
            <h1 className="text-2xl max-w-[500px] mx-auto sm:text-3xl md:text-4xl lg:text-5xl xl:text-[40px] 2xl:text-7xl font-bold font-red-hat-display text-white mb- leading-[150%]">
              Press Releases
            </h1>
            <Image
              src="/home/line.png"
