...
export default function KnowledgeHubSection() {
  return (
    <section
      className="w-full flex flex-col items-center py-8 px-2 sm:px-4 -mt-20"
      style={{
        background: "linear-gradient(180deg, #F4E6E7 64%, #fff 0%)",
        minHeight: "100vh",
      }}
    >
      <div className="w-full max-w-[1100px] flex flex-col items-center">
        ...
        <p className="text-[#8C8C8C] font-poppins text-base text-center mb-8">
          Your gateway to energy intelligence and thought leadership.
        </p>

        {/* Main Card */}
        <div className="w-[700px] mt-2 bg-white rounded-[18px] shadow-lg flex flex-col md:flex-row px-0 py-8 md:py-12 mx-auto items-stretch relative gap-8">
          {/* Articles/Insights */}
          <div className="flex flex-1 flex-col px-7 pt-2 pb-2 justify-between">
            ...
            <h3 className="font-serif font-bold text-2xl leading-[135%] text-[#243C4B] mb-5 align-middle">
              Articles <br className="" /> and Insights
            </h3>
            <div className="mb-3">
              <div className="font-serif font-bold text-base leading-[135%] text-[#243C4B] mb-2 align-middle">
                INDUSTRY PERSPECTIVE
              </div>
              <div className="font-sans font-normal text-[15px] leading-[150%] text-[#6D6D6D] mb-3 align-middle">
              ...
              <div className="font-sans font-normal text-[15px] leading-[150%] text-[#6D6D6D] align-middle">
          ...
          {/* CENTER LINE */}
          <div className="hidden md:flex items-stretch justify-center px-0">
